!(function () {
  ...
  function f(e) {
    if (e instanceof E) {
      var t = e.subject
      t && "none" != getComputedStyle(t).display
        ? h(
            e,
            (function (e) {
              if (e) {
                  ...
                  switch (getComputedStyle(e)["overflow-x"]) {
                    ...
                    case "hidden":
                      return e == document.body &&
                        "visible" ==
                          getComputedStyle(document.scrollingElement).overflow
  ...
  function h(e, t) {
    ...
    if (
      i != t &&
      (i && r && u(i).removeEventListener("scroll", r),
      (s.get(e).source = t),
      t)
    ) {
      var a = function () {
      ...
      u(t).addEventListener("scroll", a), (n.scrollListener = a)
    }
  }
  function d(e, t) {
    for (var n = s.get(e).animations, i = 0; i < n.length; i++)
      n[i].animation == t && n.splice(i, 1)
  }
  function p(e, t, n) {
    for (var i = s.get(e).animations, r = 0; r < i.length; r++)
      if (i[r].animation == t) return
    i.push({ animation: t, tickAnimation: n }), c(e)
  }
  var v = (function () {
    function e(e) {
      s.set(this, {
      ...
      t(e, [
        ...
        },
        {
          ...
          set: function (e) {
            ...
            ;(s.get(this).orientation = e), c(this)
          },
        },
        {
          key: "duration",
              ...
              i = (function (e, t) {
                ...
                return (
                  "block" === t
                    ...
                    : "inline" === t && (t = n ? "horizontal" : "vertical"),
                  "vertical" === t
  ...
  function S(e) {
    return "static" != getComputedStyle(e).position || T(e)
  }
  function b(e) {
  ...
  function k(e, t) {
    var n = s.get(e)
    if ("inactive" === e.phase) return null
    if (!(e instanceof E)) return null
    for (
      var i = e.source, r = e.subject, a = 0, o = 0, l = r, u = i.offsetParent;
      l && l != u;

    )
      (o += l.offsetLeft), (a += l.offsetTop), (l = l.offsetParent)
    ;(o -= i.offsetLeft + i.clientLeft), (a -= i.offsetTop + i.clientTop)
    var c = getComputedStyle(i),
      m = "horizontal-tb" == c.writingMode,
      f = void 0,
      h = void 0,
      d = void 0,
      p = n.orientation
    "horizontal" == p || ("inline" == p && m) || ("block" == p && !m)
      ? ((f = r.clientWidth),
        (h = o),
        ("rtl" == c.direction || "vertical-rl" == c.writingMode) &&
          (h += i.scrollWidth - i.clientWidth),
        (d = i.clientWidth))
      : ((f = r.clientHeight), (h = a), (d = i.clientHeight))
    var v = (function (e, t) {
        var n = { start: 0, end: 0 }
        if (!e) return n
        var i = e.split(" "),
        ...
        return (
          1 == r.length
            ? ((n.start = r[0]), (n.end = r[0]))
            : 2 == r.length && ((n.start = r[0]), (n.end = r[1])),
          n
        )
      })(n.inset, d),
      g = h - d + v.end,
  ...
  function w(e, t, n) {
    var i = k(e, t),
      r = k(e, "cover")
    return i && r
      ? ((n.value / 100) * (i.end - i.start) + i.start - r.start) /
          (r.end - r.start)
      : 0
  }
  var E = (function (e) {
      function n(t) {
        var n
        return (
          t.axis && (t.orientation = t.axis),
          (n = e.call(this, t) || this),
          (s.get(a(n)).subject = t && t.subject ? t.subject : void 0),
          f(a(n)),
          c(a(n)),
          n
        )
      ...
      return (
        ...
        t(n, [
          ...
          },
          {
            ...
            get: function () {
              var e = null,
                t = m(this.source, this.orientation)
              if (t == e) return e
              var n = k(this, "cover")
              return n
    ...
    x = window.Element.prototype.animate,
    I = window.Animation,
    P = ["enter", "exit", "cover", "contain"],
    R = (function () {
      function e() {
        var e = this
        ;(this.state = "pending"),
  ...
  function _(e) {
    ...
    var t = N(e, e.timeline.currentTime)
  ...
  function j(e, t) {
    if (!e.timeline) return null
    var n = N(e, e.timeline.currentTime)
    return null == n ? null : n - t / e.animation.playbackRate
  }
  function D(e, t, n) {
    if (e.timeline) {
      var i = t ? N(e, e.proxy.currentTime) : _(e)
      if (i && null != e.startTime && !e.proxy.pending) {
        ...
        r > 0 && i >= a
          ...
          : 0 != r &&
            (t && null !== e.holdTime && (e.startTime = j(e, e.holdTime)),
            (e.holdTime = null))
      }
      z(e),
        (e.previousCurrentTime = N(e, e.proxy.currentTime)),
        "finished" == e.proxy.playState
          ? (e.finishedPromise || (e.finishedPromise = new R()),
            "pending" == e.finishedPromise.state &&
              (n
                ? O(e)
  ...
  function z(e) {
    if (e.timeline)
      if (null !== e.startTime) {
        ...
        if (null == t) return
        U(e, (N(e, t) - e.startTime) * e.animation.playbackRate)
      } else null !== e.holdTime && U(e, e.holdTime)
  }
  function U(e, t) {
    var n = e.timeline,
  ...
  function H(e, t) {
    if (e.timeline) {
      ...
      null != r && ((e.startTime = r), (e.holdTime = null), L(e)),
        p(e.timeline, e.animation, F.bind(e.proxy)),
  ...
  function F(e) {
    ...
    if (null != e) {
      ...
      ;("running" != n && "finished" != n) ||
        (U(t, (N(t, e) - N(t, this.startTime)) * this.playbackRate),
        "finished" == n && 0 != W(t) && (t.holdTime = null),
        D(t, !1, !1))
  ...
  var Q = new WeakMap(),
    B = (function () {
      function e(e, t, n) {
        void 0 === n && (n = {})
        var i = e instanceof I ? e : new I(e, a),
          r = t instanceof v,
          a = r ? void 0 : t
        Q.set(this, {
          animation: i,
          ...
          effect: null,
          timeRange: t instanceof ViewTimeline ? X(n) : null,
          proxy: this,
        })
      }
      var n = e.prototype
      return (
        (n.finish = function () {
          ...
          if (e.timeline) {
            ...
            L(e)
            var i = t < 0 ? 0 : n
            this.currentTime = A(e, i)
            var r = N(e, e.timeline.currentTime)
            null === e.startTime &&
              null !== r &&
        ...
        (n.play = function () {
          var e = Q.get(this)
          e.timeline ? H(e, !0) : e.animation.play()
        }),
        (n.pause = function () {
          var e = Q.get(this)
          if (e.timeline) {
        ...
        (n.reverse = function () {
          var e = Q.get(this),
            t = W(e),
            n = e.resetCurrentTimeOnResume ? null : N(e, this.currentTime),
            i = Infinity == V(e),
            r = 0 != t && (t < 0 || n > 0 || !i)
          if (!e.timeline || !r)
            return (
              r && (e.pendingPlaybackRate = -W(e)), void e.animation.reverse()
            )
          ...
          this.updatePlaybackRate(-t), H(e, !0)
        }),
            ...
            if (!t.readyPromise || "pending" != t.readyPromise.state)
              switch (this.playState) {
                ...
                case "paused":
                  ...
                  break
                case "finished":
                  var n = N(t, t.timeline.currentTime),
                    i =
                      null !== n
            ...
            ? ("idle" != this.playState &&
                ((function (e) {
                  e.pendingTask &&
                    ((e.pendingTask = null),
                    L(e),
                    e.readyPromise.reject(M()),
                    C(e),
                    e.readyPromise.resolve(e.proxy))
                })(e),
                e.finishedPromise &&
                  "pending" == e.finishedPromise.state &&
                  e.finishedPromise.reject(M()),
                (e.finishedPromise = new R()),
                e.animation.cancel()),
              (e.startTime = null),
              (e.holdTime = null),
              d(e.timeline, e.animation))
            : e.animation.cancel()
        }),
        (n.addEventListener = function (e, t, n) {
          Q.get(this).animation.addEventListener(e, t, n)
        }),
        (n.removeEventListener = function (e, t, n) {
          Q.get(this).animation.removeEventListener(e, t, n)
        }),
        (n.dispatchEvent = function (e) {
          Q.get(this).animation.dispatchEvent(e)
        }),
        t(e, [
          {
            key: "effect",
                      ...
                      var t = e.animation.effect,
                        ...
                        i = {
                          apply: function (n) {
                            ...
                            var i = n.apply(t)
                            if (e.timeline) {
                              ;(i.localTime = A(e, i.localTime)),
                                (i.endTime = A(e, i.endTime)),
                                (i.activeDuration = A(e, i.activeDuration))
                              var r = V(e)
                              ;(i.duration = r
                                ? CSS.percent(
                                    (100 *
                          ...
                          apply: function (i, r) {
                            ...
                            return (
                              ...
                              (null === s.duration ||
                                ...
                                e.timeline &&
                                (u
                                  ? ((s.delay = o * a), (s.endDelay = l * a))
                                  : ((s.delay = 0), (s.endDelay = 0)),
            ...
            set: function (e) {
              ;(Q.get(this).animation.effect = e), (details.effect = null)
            },
          },
          {
            key: "timeline",
            ...
            set: function (e) {
              ...
              if (t != e) {
                ...
                if ((l && d(r.timeline, r.animation), s)) {
                  ;(r.timeline = e), L(r)
                  var c = r.animation.playbackRate >= 0 ? 0 : V(r)
                  switch (n) {
                    case "running":
                    case "finished":
                      ;(r.startTime = c),
                        p(r.timeline, r.animation, F.bind(this))
                      break
                    case "paused":
                      ;(r.resetCurrentTimeOnResume = !0),
                        (r.startTime = null),
                        (r.holdTime = N(r, CSS.percent(100 * o)))
                      break
                    default:
                ...
                if ((d(r.timeline, r.animation), (r.timeline = null), l))
                  switch (
                    (null !== i && (r.animation.currentTime = o * V(r)), n)
                  ) {
                    case "paused":
                      r.animation.pause()
                      break
          ...
          },
          {
            ...
            get: function () {
              var e = Q.get(this)
              return e.timeline ? A(e, e.startTime) : e.animation.startTime
            },
            set: function (e) {
              var t = Q.get(this)
              if (((e = N(t, e)), t.timeline)) {
                null == N(t, t.timeline.currentTime) &&
                  null != t.startTime &&
                  ((t.holdTime = null), z(t))
                var n = N(t, this.currentTime)
                L(t),
                  (t.startTime = e),
          ...
          },
          {
            ...
            get: function () {
              var e = Q.get(this)
              return e.timeline
                ? A(e, null != e.holdTime ? e.holdTime : _(e))
                : e.animation.currentTime
            },
            set: function (e) {
              var t = Q.get(this)
              if (((e = N(t, e)), t.timeline && null != e)) {
          ...
          },
          {
            key: "playbackRate",
            get: function () {
              return Q.get(this).animation.playbackRate
            },
            set: function (e) {
              var t = Q.get(this)
              if (t.timeline) {
          ...
          },
          {
            ...
            get: function () {
              ...
              if (
                ...
                return "paused"
              if (null != t) {
                if (e.animation.playbackRate > 0 && t >= V(e)) return "finished"
          ...
          },
          {
            key: "replaceState",
            get: function () {
              return Q.get(this).animation.pending
            },
          },
          {
            key: "pending",
          ...
          },
          {
            key: "id",
            get: function () {
              return Q.get(this).animation.id
            },
          },
          {
            key: "onfinish",
            get: function () {
              return Q.get(this).animation.onfinish
            },
            set: function (e) {
              Q.get(this).animation.onfinish = e
            },
          },
          {
            key: "oncancel",
            get: function () {
              return Q.get(this).animation.oncancel
            },
            set: function (e) {
              Q.get(this).animation.oncancel = e
            },
          },
          {
            key: "onremove",
            get: function () {
              return Q.get(this).animation.onremove
            },
            set: function (e) {
              Q.get(this).animation.onremove = e
            },
          },
          {
            key: "finished",
          ...
          },
          {
            ...
            get: function () {
              ...
              return e.timeline
                ? (e.readyPromise ||
                    ((e.readyPromise = new R()), e.readyPromise.resolve(this)),
  ...
  function K(e, t) {
    if (!e) return null
    var n = e.split(" ")
    if (!P.includes(n[0]) || (2 == n.length && !n[1].endsWith("%")))
    ...
    if (2 == n.length) {
      ...
      if (Number.isNaN(r))
        throw TypeError(
          '"' + n[1] + '" is not a valid percentage for animation delay'
        )
      i = CSS.percent(r)
    }
  ...
  function X(e) {
    var t = $(e["animation-time-range"])
    return (
      e["animation-delay"] && (t.start = K(e["animation-delay"], Y().offset)),
      e["animation-end-delay"] &&
        (t.end = K(e["animation-end-delay"], G().offset)),
      t
    )
  }
  function $(e) {
    ...
    return (
      i.length &&
        ((t.start.name = i[0]), (t.end.name = i.length > 1 ? i[1] : i[0])),
      r.length > 1 &&
  ...
  var J = {
    ...
    Z = ["block", "inline", "vertical", "horizontal"],
    ee = new ((function () {
      function e() {
      ...
      return (
        ...
        (t.getSourceElement = function (e) {
          var t = J.SOURCE_ELEMENT.exec(e)
          return t
        ...
        (t.getScrollTimelineOptions = function (e) {
          var t = this.scrollTimelineOptions.get(e)
          if (null != t && t.source) {
            var i = this.getSourceElement(t.source)
            return n(
              {},
              i ? { source: i } : {},
        ...
        (t.getViewTimelineOptions = function (e) {
          for (
            var t = this.subjectSelectorToViewTimeline.length - 1;
            t >= 0;
            t--
          ) {
            var n = this.subjectSelectorToViewTimeline[t]
            if (n.name == e) {
              var i = document.querySelectorAll(n.selector)
              if (i.length) return { subject: i[i.length - 1], axis: n.axis }
            }
          }
          return null
        }),
        (t.parseScrollTimeline = function (e) {
          ...
          this.eatWhitespace(e),
            ...
            this.eatWhitespace(e)
          for (
            var i = { name: n, source: "auto", orientation: void 0 };
            "}" !== this.peek(e);
          ...
          return (
            this.eatWhitespace(e),
            { scrollTimeline: i, startIndex: t, endIndex: a }
          )
        }),
        (t.handleScrollTimelineProps = function (e, t) {
          ...
          if (!e.selector.includes("@keyframes")) {
            ...
            var o = [],
              l = []
            r &&
              (o = this.extractMatches(e.block.contents, J.ANIMATION_TIMELINE)),
              i &&
                (l = this.extractMatches(e.block.contents, J.ANIMATION_NAME)),
              (r && i) ||
                (a &&
                  this.extractMatches(e.block.contents, J.ANIMATION).forEach(
                    function (i) {
        ...
        (t.saveSubjectSelectorToViewTimeline = function (e) {
          var t = e.block.contents.includes("view-timeline:"),
            n = e.block.contents.includes("view-timeline-name:"),
            i = e.block.contents.includes("view-timeline-axis:")
          if (t || n) {
            var r = { selector: e.selector, name: "", axis: "block" }
            if (t) {
              var a = this.extractMatches(
                e.block.contents,
                J.VIEW_TIMELINE,
                (separator = " ")
              )
              1 == a.length
                ...
                : 2 == a.length &&
                  (Z.includes(a[0])
                    ? ((r.axis = a[0]), (r.name = a[1]))
                    : ((r.axis = a[1]), (r.name = a[0])))
            }
            if (n) {
              var o = this.extractMatches(
                e.block.contents,
                J.VIEW_TIMELINE_NAME
              )
              r.name = o[0]
            }
            if (i) {
              var l = this.extractMatches(
                e.block.contents,
                J.VIEW_TIMELINE_AXIS
              )
              Z.includes(l[0]) && (r.axis = l[0])
            }
            this.subjectSelectorToViewTimeline.push(r)
          }
        }),
        (t.hasDuration = function (e) {
          return (
            e.split(" ").filter(function (e) {
              return J.TIME.exec(e)
            }).length >= 1
          )
        }),
        (t.saveRelationInList = function (e, t, i) {
          var r = e.block.contents.includes("animation-delay:"),
            ...
            o = e.block.contents.includes("animation-time-range:"),
            l = [],
            s = [],
            u = []
          r && (l = this.extractMatches(e.block.contents, J.ANIMATION_DELAY)),
            a &&
              (s = this.extractMatches(
                e.block.contents,
                J.ANIMATION_END_DELAY
              )),
            o &&
              (u = this.extractMatches(
                e.block.contents,
                J.ANIMATION_TIME_RANGE
              ))
          for (
            var c = Math.max(t.length, i.length, l.length, s.length, u.length),
              m = 0;
            m < c;
            m++
          )
            this.cssRulesWithTimelineName.push(
              n(
                { selector: e.selector, "animation-timeline": t[m % t.length] },
                i.length ? { "animation-name": i[m % i.length] } : {},
                l.length ? { "animation-delay": l[m % l.length] } : {},
                s.length ? { "animation-end-delay": s[m % s.length] } : {},
                u.length ? { "animation-time-range": u[m % u.length] } : {}
              )
            )
        }),
        ...
        (t.parseIdentifier = function (e) {
          J.IDENTIFIER.lastIndex = e.index
          var t = J.IDENTIFIER.exec(e.sheetSrc)
        ...
        (t.eatWhitespace = function (e) {
          J.WHITE_SPACE.lastIndex = e.index
          var t = J.WHITE_SPACE.exec(e.sheetSrc)
    ...
    (CSS.supports("animation-timeline: works") ||
      ((function () {
        function e(e) {
          if (0 !== e.innerHTML.trim().length) {
            var t = ee.transpileStyleSheet(e.innerHTML, !0)
            ;(t = ee.transpileStyleSheet(t, !1)), (e.innerHTML = t)
          }
        }
        new MutationObserver(function (t) {
          for (var n, i = l(t); !(n = i()).done; )
            for (var r, a = l(n.value.addedNodes); !(r = a()).done; ) {
              var o = r.value
      ...
      window.addEventListener("animationstart", function (e) {
        e.target
          ...
          .forEach(function (t) {
            var n = (function (e, t) {
              var n = ee.getAnimationTimelineOptions(e, t),
                i = n["animation-timeline"]
              if (!i) return null
              var r =
                ee.getScrollTimelineOptions(i) || ee.getViewTimelineOptions(i)
              return r
                ? { timeline: r.source ? new v(r) : new E(r), animOptions: n }
                : null
            })(t.animationName, e.target)
            if (n.timeline && t.timeline != n.timeline) {
              var i = new B(t, n.timeline, n.animOptions)
              t.pause(), i.play()
            }
          })
      })),
    ...
    !Reflect.defineProperty(Element.prototype, "animate", {
      value: function (e, t) {
        ...
        var i = function (e, t) {
          ...
          r = function (e, t) {
            t &&
              (t.phase && (e.name = t.phase),
              t.percent && (e.offset = t.percent))
          },
          a = i(t, "delay"),
          o = i(t, "endDelay"),
          l = x.apply(this, [e, t]),
        ...
        if (n instanceof v) {
          if ((l.pause(), n instanceof ViewTimeline)) {
            var u = Q.get(s)
            ;(u.timeRange = $(t.timeRange)),
              r(u.timeRange.start, a),
              r(u.timeRange.end, o)
          }
          s.play()
        }
  ...
  if (!Reflect.defineProperty(window, "Animation", { value: B }))
